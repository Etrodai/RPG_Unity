...
public class CheatEditor : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        Rect functionNameRect = new Rect(position.x, commandRect.y + EditorGUIUtility.singleLineHeight + Y_OFFSET, position.width, EditorGUIUtility.singleLineHeight);
    ...
    private string[] GetCheatMethods()
    {
        ...
        methods.AddRange(typeof(CheatCodeLogic).GetMethods().Where(method => method.DeclaringType == typeof(CheatCodeLogic)));
